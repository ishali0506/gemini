    ...
    <div className="main">
      ...
      <div className="main-container">
        ...
        <div className="main-bottom">
          ...
          <p className="bottom-info"> Gemini may display inaccurate info, including about people, so double-chcek its responses. Your privacy and Gemini Apps</p>
        </div>
      </div>
    </div>
  );
